    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td>
                    <ul>
                    <li style="list-style: none;"><a class="btn btn-danger bi bi-pencil" href="inscripcion.php?accion=participanteEvento&id_evento=<?php echo $id_evento;?>&id_cliente=<?php echo $dato['id_cliente']; ?>&accion_participante=eliminar">Eliminar</a></li>
                    </ul>
                </td>
            </tr>
        <?php
