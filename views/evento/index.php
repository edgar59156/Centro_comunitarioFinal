...
<!-- Jumbotron -->
<div id="intro" class="p-5 text-center bg-light" style="background-image: url('/centro_comunitario/image/proyecto/car1.jpg');">
...
<main class="my-5">
  <div class="container">
    ...
    <section class="text-center">
      <h1 class="mb-5"><strong>Eventos</strong></h1>
