          ...
          <div class="card" style="border-radius: 1rem;">
            <div class="row g-0">
              <div class="col-md-6 col-lg-5 d-none d-md-block">
                <img src="../image/login/fondo_login2.jpg" alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem; width: auto; height: 700px;" />
              </div>
              <div class="col-md-6 col-lg-7 d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <p class="mb-5 pb-lg-2" style="color: #393f81;">¿Aun no tienes cuenta? <a href="../panel/registro.php" style="color: #393f81;">Registrate aquí</a></p>
