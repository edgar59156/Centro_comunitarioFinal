...
<form method="GET" action="inicioTallerista.php">
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td>
                    <ul>
                    <li style="list-style: none;"><a class="btn btn-danger bi bi-pencil" href="inicioTallerista.php?accion=participanteTaller&id_taller=<?php echo $id_taller;?>&id_cliente=<?php echo $dato['id_cliente']; ?>&accion_participante=eliminar">Eliminar</a></li>
                    </ul>
                </td>
            </tr>
        <?php
